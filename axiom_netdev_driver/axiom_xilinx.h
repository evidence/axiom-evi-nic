...
#define XREGISTER_CONTROLLER_REGISTERS_BITS_CONTROL_V_DATA     4
#define XREGISTER_CONTROLLER_REGISTERS_ADDR_AXCACHE_V_DATA     0x80
#define XREGISTER_CONTROLLER_REGISTERS_BITS_AXCACHE_V_DATA     4
#define XREGISTER_CONTROLLER_REGISTERS_ADDR_AXPROT_V_DATA      0x88
#define XREGISTER_CONTROLLER_REGISTERS_BITS_AXPROT_V_DATA      3
